        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#0072BC] px-5 py-3 text-sm font-black text-white shadow-lg shadow-[#0072BC]/20 transition-all hover:-translate-y-0.5 hover:bg-[#005f9e] hover:shadow-xl"
            >
